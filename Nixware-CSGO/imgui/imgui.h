...
namespace ImGui
{
	...
	IMGUI_API bool          MyButton(const char* label, const char* icon, ImFont* icon_font, bool inuse, const ImVec2& size_arg);    // button
