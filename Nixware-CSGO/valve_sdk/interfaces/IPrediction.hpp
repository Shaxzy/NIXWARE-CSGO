...
public:
    ...
    {
        typedef void(__thiscall* oRunCommand)(PVOID, C_BasePlayer*, CUserCmd*, IMoveHelper*);
        return CallVFunction<oRunCommand>(this, 19)(this, player, ucmd, moveHelper);
    }

    void SetupMove(C_BasePlayer *player, CUserCmd *ucmd, IMoveHelper *moveHelper, PVOID pMoveData)
    {
        typedef void(__thiscall* oSetupMove)(PVOID, C_BasePlayer*, CUserCmd*, IMoveHelper*, PVOID);
        return CallVFunction<oSetupMove>(this, 20)(this, player, ucmd, moveHelper, pMoveData);
    }

    void FinishMove(C_BasePlayer *player, CUserCmd *ucmd, PVOID pMoveData)
    {
        typedef void(__thiscall* oFinishMove)(PVOID, C_BasePlayer*, CUserCmd*, PVOID);
